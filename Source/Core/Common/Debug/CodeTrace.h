...
public:
  ...
  AutoStepResults AutoStepping(std::vector<TraceOutput>* output_trace, bool continue_previous,
                               AutoStop stop_on);
  bool RecordTrace(std::vector<TraceOutput>* output_trace, size_t record_limit, u32 time_limit,
